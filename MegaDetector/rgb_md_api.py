# python Desktop/opencv_comp/rgb_md_api.py
...
#frame_manip = pipeline.create(depthai.node.ImageManip)
#frame_manip.initialConfig.setResize(600, 600)
#frame_manip.setMaxOutputFrameSize(1048576)
#frame_manip.initialConfig.setFrameType(depthai.RawImgFrame.Type.RGB888p)
#cam_rgb.preview.link(frame_manip.inputImage)

# Next, we want a neural network that will produce the detections
detection_nn = pipeline.createNeuralNetwork()
# Blob is the Neural Network file, compiled for MyriadX. It contains both the definition and weights of the model
# We're using a blobconverter tool to retreive the MobileNetSSD blob automatically from OpenVINO Model Zoo
detection_nn.setBlobPath(md_blob_path)
...
#frame_manip.out.link(detection_nn.input)
...
#frame_manip.out.link(xout_rgb.input)
